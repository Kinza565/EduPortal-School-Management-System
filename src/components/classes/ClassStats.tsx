import { BookOpen, Layers, CheckCircle, XCircle } from "lucide-react";
...
export function ClassStats({ total, active, inactive, totalSections }: ClassStatsProps) {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <StatCard
        ...
        iconBg="bg-purple-50"
        change={total > 0 ? `Avg ${Math.round(totalSections / total)} per class` : "No classes yet"}
        changeType="neutral"
      />
    </div>
  );
