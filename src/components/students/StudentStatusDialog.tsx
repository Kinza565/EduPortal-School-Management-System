        ...
        <div className="mb-4 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-slate-500">
              {isActive
                ? "This student will be marked as inactive but all records will be preserved."
                : "This student will be reactivated and regain access to the system."}
            </p>
          </div>
          <button
            onClick={onCancel}
        ...
        {isActive && (
          <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 p-3">
            <p className="text-xs text-amber-700">
              <strong>Note:</strong> Deactivated students will not appear in active lists, but all attendance, assignments, and records will remain in the system.
            </p>
          </div>
        )}
