        ...
        <div className="mb-4 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-slate-500">
              {isActive
                ? "This teacher will be marked as inactive but their data will be preserved."
                : "This teacher will be reactivated and regain access to the system."}
            </p>
          </div>
          <button
            onClick={onCancel}
        ...
        {isActive && (
          <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 p-3">
            <p className="text-xs text-amber-700">
              <strong>Note:</strong> Deactivated teachers will not be able to log in, but all their records will remain in the system.
            </p>
          </div>
        )}
