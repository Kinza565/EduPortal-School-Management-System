import { Layers, CheckCircle, XCircle, Users, Armchair } from "lucide-react";
...
export function SectionStats({ total, active, inactive, totalStudents, availableSeats }: SectionStatsProps) {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <StatCard
        ...
        iconBg="bg-amber-50"
        change={availableSeats < 0 ? "Over capacity!" : "Total capacity"}
        changeType={availableSeats < 0 ? "negative" : "neutral"}
      />
    </div>
  );
}
