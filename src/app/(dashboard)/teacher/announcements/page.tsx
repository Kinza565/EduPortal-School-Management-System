  ...
  const fetchAnnouncements = useCallback(async () => {
    ...
    try {
      ...
      const query = supabase
        ...
        .eq("is_active", true)
        .or(
          `target_type.in.(all,teachers),target_type.eq.class_and.class_id.in.(${assignedClassIds.join(",") || "null"}),target_type.eq.section_and.section_id.in.(${assignedSectionIds.join(",") || "null"})`
        );
